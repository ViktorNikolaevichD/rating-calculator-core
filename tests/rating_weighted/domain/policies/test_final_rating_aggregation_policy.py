...
def test_base_rating_contribution_policy_applies_exponential_decay_by_total_weight(
    ...
    result = base_rating_contribution_policy.apply(base_rating=4.0, total_mark_weight=4.0)
...
def test_full_formula_can_be_composed_from_two_policies_and_one_aggregator(
    ...
    base_rating_contribution = base_rating_contribution_policy.apply(base_rating=2.0, total_mark_weight=4.0)
